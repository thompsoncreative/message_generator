...
const randomOccupation = () => {
    const randomIndex = Math.floor(Math.random() * occupation.length);
...
//generates message with random variables, checks occupations beginning with vowels and corrects grammar.
const generateMessage = () => {
    const chosenOccupation = randomOccupation();
    switch (chosenOccupation[0]) {
        case 'A':
        case 'E':
        case 'I':
        case 'O':
        case 'U':    
        console.log(`Hi, my name is ${randomFirstName()} ${randomLastName()}. I am an ${chosenOccupation} working in ${randomCity()}.`)
        break;
        default: console.log(`Hi, my name is ${randomFirstName()} ${randomLastName()}. I am a ${chosenOccupation} working in ${randomCity()}.`);
